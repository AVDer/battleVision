...
namespace test_generator {
  ...
  int generate_battle_file() {
    ...
    units_info.push_back(UnitInfo(
        UnitGeneralInfo(2, 1, 4000, unit_type_t::infantry, "Platea"),
        {{110, 427}, color_t(0), shape_t::rectangle, {110, 34}, 226, unit_state_t::alive}
    ));
    units_info.push_back(UnitInfo(
        UnitGeneralInfo(3, 1, 4000, unit_type_t::infantry, "Athens (Kallimah)"),
        {{461, 762}, color_t(0), shape_t::rectangle, {110, 34}, 226, unit_state_t::alive}
    ));
    units_info.push_back(UnitInfo(
        UnitGeneralInfo(4, 2, 100, unit_type_t::infantry, "1st infantry line"),
        {{537, 392}, color_t(0), shape_t::rectangle, {314, 12}, 44, unit_state_t::alive}
    ));
    units_info.push_back(UnitInfo(
        UnitGeneralInfo(5, 2, 100, unit_type_t::infantry, "2nd infantry line"),
        {{580, 374}, color_t(0), shape_t::rectangle, {362, 25}, 44, unit_state_t::alive}
    ));
    units_info.push_back(UnitInfo(
        UnitGeneralInfo(6, 2, 100, unit_type_t::infantry, "3rd infantry line"),
        {{615, 344}, color_t(0), shape_t::rectangle, {362, 25}, 44, unit_state_t::alive}
    ));
    units_info.push_back(UnitInfo(
        UnitGeneralInfo(7, 2, 500, unit_type_t::cavalry, "Right cavalry wing"),
        {{681, 534}, color_t(0), shape_t::rectangle, {66, 18}, 44, unit_state_t::alive}
    ));
    units_info.push_back(UnitInfo(
        UnitGeneralInfo(8, 2, 500, unit_type_t::cavalry, "Left cavalry wing"),
    ...
    maneuvers.push_back(std::move(ManeuverFactory::create(ManeuverType::move, 1, time_point_t(std::chrono::seconds(1)), time_point_t(std::chrono::seconds(9)),
                                                  {"280", "601", "340", "548"})));
    maneuvers.push_back(ManeuverFactory::create(ManeuverType::rotate, 1, time_point_t(std::chrono::seconds(1)), time_point_t(std::chrono::seconds(9)),
                                                  {"226", "224"}));
    maneuvers.push_back(ManeuverFactory::create(ManeuverType::resize, 1, time_point_t(std::chrono::seconds(1)), time_point_t(std::chrono::seconds(9)),
                                                {"220", "18", "235", "12"}));
    ...
    for (const auto& maneuver : maneuvers) {
      ...
      maneuver_node.put("type", static_cast<std::underlying_type_t<ManeuverType >>(maneuver->maneuver_type()));
